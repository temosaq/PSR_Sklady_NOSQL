...
public class HListener {
    public static void main(String[] args) throws UnknownHostException {
		...
		IMap<Long, Patient> patients = instance.getMap("patients");

		patients.addEntryListener(new EntryAddedListener<Long, Patient>() {

			@Override
			public void entryAdded(EntryEvent<Long, Patient> e) {
				System.out.println(e);
			}
		}, true);
